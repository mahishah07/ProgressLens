		...
		<header className="topbar eo-main-topbar">
			<div className="topbar-brand">
				<div>
					...
					<span className="topbar-context">Error Pattern Analysis</span>
				</div>
			</div>
...
<<<<<<< Updated upstream
	...
	const openStudentDashboard = async (event) => {
		...
		try {
			...
			if (ERROR_API) {
				const response = await fetch(
					`${ERROR_API}/students?q=${encodeURIComponent(query)}`,
				);
			...
			navigate(`/error-options/${encodeURIComponent(profile.studentId)}`);
		} catch (error) {
			alert(error.message);
		} finally {
			setStudentSearching(false);
			...
			<div className="eo-page">
				<main className="eo-main">
					<div className="eo-state-card">
						...
						<p>Retrieving the latest student information...</p>
					</div>
				</main>
			</div>
		);
		...
		<div className="eo-page">
			...
			<main className="eo-main">
				...
				<div className="eo-content">
						...
						<div className="eo-profile-meta">
							...
							<div className="eo-meta-item">
								...
								<div>
									...
									<span className="eo-meta-value">{centre}</span>
								</div>
							</div>
						</div>
					</section>
					...
					<section className="eo-section-heading">
						<div>
							<span className="eo-eyebrow">ERROR ANALYSIS</span>

							<h2>Choose an analysis method</h2>

							<p>Select the workflow that matches the assessment.</p>
						</div>
					</section>
					...
					<section className="eo-options">
						...
						>
							...
							<div className="eo-option-header">
								...
								<span className="eo-card-type">ANSWER KEY REQUIRED</span>
							</div>

							<div className="eo-option-content">
								<h3>Reference-Based Analysis</h3>

								<p>
									Compare a student submission with an uploaded answer key and
							...
							<FileCheck2 className="eo-background-icon" size={185} />
						</article>
						...
						>
							...
							<div className="eo-option-header">
								...
								<span className="eo-card-type">NO ANSWER KEY</span>
							</div>

							<div className="eo-option-content">
								<h3>Free-Form Analysis</h3>

								<p>
									Analyse open-ended writing for recurring literacy and writing
									error patterns.
								</p>
							</div>
							...
							<BarChart3 className="eo-background-icon" size={185} />
						</article>
					</section>
