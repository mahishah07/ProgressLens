...
function saveOpenAiAnalysis(id, writingSampleId, errors, expectedText, recommendation, session = null) {
  return AnalysisReport.findOneAndUpdate(
    { _id: id, writingSample: writingSampleId },
    { errors, expectedText, interventionRecommendation: recommendation, openAiAnalysedAt: new Date() },
